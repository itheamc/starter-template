...
final loginRequestStateProvider =
    StateNotifierProvider<LoginRequestStateNotifier, LoginRequestState>(
  (ref) {
    final repository = ref.read(authRepositoryProvider);
    return LoginRequestStateNotifier(
      LoginRequestState(),
      repository,
      ref,
    );
...
///
class LoginRequestStateNotifier extends StateNotifier<LoginRequestState> {
  LoginRequestStateNotifier(
    super.state,
    this._repository,
    this._ref,
